...
import ImgRedback from "../assets/redback.png";
...
import CHThumb from "../assets/ch_thumb.jpeg";
import CHContentIntro from "../assets/ch_intro.webm";
import CHContentCubes from "../assets/ch_cubes.webm";
import CHContentTimeline from "../assets/ch_timeline.webm";
	...
	return (
		<div className="relative w-full bg-planet min-h-[100vh] flex flex-col items-center z-10">
			...
			<div className="max-w-[70rem] w-full flex-auto mt-8 flex flex-col gap-8 overflow-hidden p-4 lg:gap-y-48 lg:mt-48">
				<Project
					title={"Charter Hall Annual Reports Story"}
					tags={[
						"UI/UX",
						"Design",
						"3D",
				...
				>
					<p>
						A Delta Studio engagement with Charter Hall, creating an
						interactive summary of their 2025 Annual Reports to
						celebrate 20 years since being listed on the ASX.
					</p>
					<p>
						I built this engagement closely with a team in Charter
						Hall, leveraging their design and already established
						brand, I brought to life this story using React.
					</p>
					<Dialog.Root>
				...
				<Project
					title={"Redback Boots"}
					tags={["Brand", "UI/UX", "Storytelling", "Astro", "React"]}
					img={ImgRedback}
					link={"https://redbackboots.com.au/"}
				>
					<p>
						A Delta Studio engagement with Australia's Redback
						Boots. We built the website in collaboration with a
						design studio as part of an initiative to refresh the
						Redback brand.
					</p>
					<p>
						I built many of the deliverables on the frontend side
						using an Astro foundation, with more complex features
						being constructed in React.
					</p>
				</Project>
				<Project
			...
			<div className="max-w-[45rem] gap-y-8 flex flex-col">
				<div className="w-full aspect-video ">
					<video
						...
						loop
						className="w-full h-full rounded-lg"
						src={CHContentTimeline}
					/>
				</div>

				<p className="w-full ">
					This interaction was developed closely with one of the
					marketing teams inside Charter Hall. Their goal was to
					deliver a new and exciting story showcasing the year end
					results across their four main property funds.
				</p>
				...
				<p className="w-full ">
					Each fund had it's own story, and pulled out highlights and
					key takeaways from their year end reports. Three interactive
					case studies were also created to showcase the impact
					Charter Hall has had on its community in the past year.
				</p>
				<div className="w-full  aspect-video ">
					<video
						loop
